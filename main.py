...
def transform_1():
    ...
    try:
        ...
        reader.drop(columns=['new_deaths_smoothed_per_million'],inplace=True)
        reader.drop(columns=['new_cases_smoothed'],inplace=True)
        ...
        reader.drop(columns=['new_people_vaccinated_smoothed_per_hundred'],inplace=True)
        reader.drop(columns=['new_people_vaccinated_smoothed'],inplace=True)
        reader.drop(columns=['new_vaccinations_smoothed_per_million'],inplace=True)
        reader.drop(columns=['new_vaccinations_smoothed'],inplace=True)
        reader.drop(columns=['new_tests_smoothed'],inplace=True)
        reader.drop(columns=['new_tests_smoothed_per_thousand'],inplace=True)
        reader.drop(columns=['total_deaths_per_million'],inplace=True)
        reader.drop(columns=['new_deaths_per_million'],inplace=True)
        reader.drop(columns=['new_cases_smoothed_per_million'],inplace=True)
        reader.drop(columns=['new_cases_per_million'],inplace=True)
        reader.drop(columns=['new_deaths_smoothed'],inplace=True)
